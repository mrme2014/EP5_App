...
//    public static final String LOCAL_THUMB_PATH = Environment.getExternalStorageDirectory() + "/" + "remoteCam/thumb";
    ...
    public static final String LOCAL_PHOTO_PATH = Environment.getExternalStorageDirectory() + "/" + "aaa/Image";
    public static final String LOCAL_VIDEO_PATH = Environment.getExternalStorageDirectory() + "/" + "aaa/Video";
    public static final String LOCAL_THUMB_PATH = Environment.getExternalStorageDirectory() + "/" + "aaa/thumb";
    public static final String LOCAL_EDIT_PATH = Environment.getExternalStorageDirectory() + "/" + "aaa/Edit";

...
public class ProfileItem {
    ...
    public static ArrayList<String> getCircleRecodList() {
        if (!list_cyclic_rec.isEmpty())
            return list_cyclic_rec;
        list_cyclic_rec.add("OFF");
        list_cyclic_rec.add("3mis");
        list_cyclic_rec.add("5min");
        list_cyclic_rec.add("10min");
    ...
    public static ArrayList<String> getAutoPowerOFFList() {
        if (!list_auto_power_off.isEmpty())
            return list_cyclic_rec;
        list_auto_power_off.add("OFF");
        list_auto_power_off.add("3mis");
        list_auto_power_off.add("5min");
        list_auto_power_off.add("10min");

        return list_auto_power_off;
    }
}

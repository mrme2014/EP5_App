...
import com.qiaomu.libvideo.view.MediaController;
...
public class QiaomuPlaybackActivity extends Activity implements
        PLUploadResultListener,
        PLUploadProgressListener {

    private static final String TAG = "QiaomuPlaybackActivity";
        ...
        public boolean onInfo(PLMediaPlayer plMediaPlayer, int what, int extra) {
            ...
            switch (what) {
                ...
                case PLMediaPlayer.MEDIA_INFO_VIDEO_RENDERING_START:
                    //ToastUtils.s(QiaomuPlaybackActivity.this, "first video render time: " + extra + "ms");
                    break;
        ...
        public boolean onError(PLMediaPlayer mp, int errorCode) {
            ...
            switch (errorCode) {
                ...
                case PLMediaPlayer.ERROR_CODE_OPEN_FAILED:
                    ToastUtils.s(QiaomuPlaybackActivity.this, "failed to open player !");
                    break;
                case PLMediaPlayer.ERROR_CODE_SEEK_FAILED:
                    ToastUtils.s(QiaomuPlaybackActivity.this, "failed to seek !");
                    break;
                default:
                    ToastUtils.s(QiaomuPlaybackActivity.this, "unknown error !");
                    break;
            }
            finish();
            return true;
    ...
    private PLMediaPlayer.OnCompletionListener mOnCompletionListener = new PLMediaPlayer.OnCompletionListener() {
        ...
        public void onCompletion(PLMediaPlayer plMediaPlayer) {
            ...
            ToastUtils.s(QiaomuPlaybackActivity.this, "Play Completed !");
            finish();
        }
    };

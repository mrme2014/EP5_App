...
public class Config {
    ...
    public static final String VIDEO_STORAGE_DIR = Environment.getExternalStorageDirectory() + "/C-Video/Trim";
    ...
    public static final String TRIM_FILE_PATH = VIDEO_STORAGE_DIR + "/trimmed.MOV";
    public static final String TRANSCODE_FILE_PATH = VIDEO_STORAGE_DIR + "/transcoded.MOV";
    ...
    public static final String FILE_PATH_TRIMMED = Environment.getExternalStorageDirectory() + "/C-Video/Trim";
    public static final String FILE_PATH_TRANSCODE = Environment.getExternalStorageDirectory() + "/C-Video/Transcode";
}